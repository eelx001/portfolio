...
firstPlatform.addEventListener('click',()=>{
    window.open("https://www.instagram.com/eelx001/");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:mehdimedy12@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/eelx001");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/joumad-el-mehdi-926a28236/");
});